...
if(!function_exists('wppm_page_inline_script')) {
  function wppm_page_inline_script() { ?>
    ...
    function wppm_get_project_tasks(id){
      ...
      var dataform=new FormData(jQuery('#wppm_get_project_tasks_frm')[0]);
      <?php echo do_action('wppm_get_project_tasks_dataform');?>
      dataform.append("action", 'wppm_get_project_tasks');
