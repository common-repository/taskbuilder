  ...
  final class WPPM_Admin {
    ...
    public function __construct() {
     ...
     // add_action( 'admin_init',array($this,'wppm_appearance_setting_tab') );
      ...
      add_action('wp_ajax_wppm_get_bulk_change_proj_status',array($this,'wppm_get_bulk_change_proj_status'));
      add_action('wp_ajax_wppm_set_bulk_change_project_status',array($this,'wppm_set_bulk_change_project_status'));
      add_action('wp_ajax_wppm_get_bulk_change_proj_cat',array($this,'wppm_get_bulk_change_proj_cat'));
      add_action('wp_ajax_wppm_set_bulk_change_project_category',array($this,'wppm_set_bulk_change_project_category'));
      add_action('wp_ajax_wppm_get_bulk_assign_users',array($this,'wppm_get_bulk_assign_users'));
      add_action('wp_ajax_wppm_set_bulk_project_users',array($this,'wppm_set_bulk_project_users'));
      add_action('wp_ajax_wppm_get_bulk_delete_project',array($this,'wppm_get_bulk_delete_project'));
      add_action('wp_ajax_wppm_set_delete_bulk_projects',array($this,'wppm_set_delete_bulk_projects'));
      add_action('wp_ajax_wppm_get_bulk_change_task_status',array($this,'wppm_get_bulk_change_task_status'));
      add_action('wp_ajax_wppm_set_bulk_change_task_status',array($this,'wppm_set_bulk_change_task_status'));
      add_action('wp_ajax_wppm_get_bulk_change_task_priority',array($this,'wppm_get_bulk_change_task_priority'));
      add_action('wp_ajax_wppm_set_bulk_change_task_priority',array($this,'wppm_set_bulk_change_task_priority'));
    ...
    public function wppm_get_bulk_change_proj_status($proj_ids){
      include WPPM_ABSPATH.'includes/admin/projects/wppm_get_bulk_change_proj_status.php';
      die();
    }

    public function wppm_set_bulk_change_project_status(){
      include WPPM_ABSPATH.'includes/admin/projects/wppm_set_bulk_change_proj_status.php';
      die();
    }

    public function wppm_get_bulk_change_proj_cat($proj_ids){
      include WPPM_ABSPATH.'includes/admin/projects/wppm_get_bulk_change_proj_cat.php';
      die();
    }

    public function wppm_set_bulk_change_project_category(){
      include WPPM_ABSPATH.'includes/admin/projects/wppm_set_bulk_change_project_category.php';
      die();
    }

    public function wppm_get_bulk_assign_users($proj_ids){
      include WPPM_ABSPATH.'includes/admin/projects/wppm_get_bulk_assign_users.php';
      die();
    }

    public function wppm_set_bulk_project_users(){
      include WPPM_ABSPATH.'includes/admin/projects/wppm_set_bulk_project_users.php';
      die();
    }

    public function wppm_get_bulk_delete_project($proj_ids){
      include WPPM_ABSPATH.'includes/admin/projects/wppm_get_bulk_delete_project.php';
      die();
    }

    public function wppm_set_delete_bulk_projects(){
      include WPPM_ABSPATH.'includes/admin/projects/wppm_set_delete_bulk_projects.php';
      die();
    }

    public function wppm_get_bulk_change_task_status($task_ids){
      include WPPM_ABSPATH.'includes/admin/tasks/wppm_get_bulk_change_task_status.php';
      die();
    }

    public function wppm_set_bulk_change_task_status(){
      include WPPM_ABSPATH.'includes/admin/tasks/wppm_set_bulk_change_task_status.php';
      die();
    }

    public function wppm_get_bulk_change_task_priority($task_ids){
      include WPPM_ABSPATH.'includes/admin/tasks/wppm_get_bulk_change_task_priority.php';
      die();
    }

    public function wppm_set_bulk_change_task_priority(){
      include WPPM_ABSPATH.'includes/admin/tasks/wppm_set_bulk_change_task_priority.php';
      die();
    }

    public function wppm_get_bulk_delete_task($task_ids){
      include WPPM_ABSPATH.'includes/admin/tasks/wppm_get_bulk_delete_task.php';
      die();
    }

    public function wppm_set_delete_bulk_tasks(){
      include WPPM_ABSPATH.'includes/admin/tasks/wppm_set_delete_bulk_tasks.php';
      die();
    }
