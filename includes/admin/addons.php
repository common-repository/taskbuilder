        ...
        <div class="col-sm-12">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="pbody">
                            <div class="addon-container">
                                <i class="fas fa-arrow-right"></i>
                                <div class="addon-details">
                                    <?php echo esc_html_e('Time Tracker add-on will help you to record and track the time spent on each individual task. We have designed this like a stop-watch for a task.','taskbuilder');?><
                                    </div>
                                </div>
                        </div>
                        <div class="pfooter">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 pricing-widget">
                    <div class="row">
                        <div class="pheader">
                            <h3 class="title"><img src="<?php echo esc_url( WPPM_PLUGIN_URL . 'asset/images/taskbuilder_wc.svg'); ?>"> <?php echo esc_html_e('WooCommerce Integration','taskbuilder');?></h3>
                            <h4 class="subtitle">$29.99</h4>
                            <div style="text-align:center">
                                <small class="payment_freq"><?php echo esc_html_e('Per year','taskbuilder');?></small>
                                <small class="payment_freq"><?php echo esc_html_e('(Add-ons subject to yearly license for support and updates.)','taskbuilder');?></small>
                        ...
                        <div class="pbody">
                            <div class="addon-container">
                                <i class="fas fa-arrow-right"></i>
                                <div class="addon-details">
                                <?php echo esc_html_e('WooCommerce extention allows you to automatically create task after order received. You can set task fields in setting. In task description you can set order details like product qty,price, total etc.','taskbuilder');?></div>
                            </div>
                        </div>
                        <div class="pfooter">
                            <div class="purchase_addon">
                            ...
                            <div>
                                <a href="https://taskbuilder.net/woocommerce/" target="__blank" type="button" class="btn btn-success"><?php echo esc_html_e('View Details','taskbuilder');?></a>
                            </div>
                        </div>
                    </div>
                </div>
