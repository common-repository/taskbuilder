...
<form id="frm_get_task_creator" method="post">
	<div class="row" style="padding-left:2px;">
		<div class="col-sm-12">
			...
			<input type="text" id="user_name" class="form-control wppm_regi_user_autocomplete ui-autocomplete-input" name="customer_name" autocomplete="off" value="<?php echo isset($task_creator->display_name)? htmlentities(stripcslashes(esc_attr($task_creator->display_name))):""?>">
   	    </div>
    </div>
    ...
    <input type="hidden" name="user_id" id="user_id" value="<?php echo isset($task_creator->ID) ? esc_attr($task_creator->ID) : ""; ?>">
