...
if (!(($current_user->ID && $current_user->has_cap('manage_options')) || $wppmfunction->has_proj_comment_permission('edit_proj_comment',$proj_id,$comment_id) || ($current_user->ID && $current_user->has_cap('wppm_admin')))) {exit;}
ob_start();
?>
